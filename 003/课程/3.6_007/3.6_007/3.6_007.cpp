// 3.6_007.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main()
{
    ...
    Add(a);
    cout << a << endl;
    //函数形参为值参数，传入实参为引用变量，结果不对引用变量指向的对象产生影响。说明形参复制的是引用变量指向的值，而非复制引用变量所指向的地址。
    a = 0;
    Add(ra);
    cout << a << endl;
