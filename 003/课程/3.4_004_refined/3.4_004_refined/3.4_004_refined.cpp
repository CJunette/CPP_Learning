...
void HanoiMove(int n, int paintIndex, Plate* plate, Stick source, Stick mediate, Stick target);
...
void HanoiMove(int n, int paintIndex, Plate* plate, Stick source, Stick mediate, Stick target)
{
    ...
    {
        HanoiMove(n - 1, paintIndex, plate, source, target, mediate);
        plate[n].current = target;
        Paint(paintIndex, plate);
        HanoiMove(n - 1, paintIndex, plate, mediate, source, target);
    }
}